    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6 py-6">
        ...
        <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-4 text-xs text-slate-300 leading-relaxed">
          ...
          <p>
            When uploading your dataset in Step 01, provide an optional <code className="text-cyan-300">survival.csv</code> file containing:
          </p>
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs shadow-md transition-all"
        >
